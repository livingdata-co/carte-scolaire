...
export async function buildCarteSecteurFeatures(codeCommune, rows) {
  ...
  console.log(`${codeCommune} | Adresses totales : ${adresses.length} - Adresses trouvées : ${adressesFeatures.length} | Ratio : ${((adressesFeatures.length / adresses.length) * 100).toFixed(0)}%`)
